...
///
/// NOTE: `_csrf_token` is automatically appended to the call by
/// `form! { method: Post, ... }` (codegen.rs:1512). The framework verifies the
/// token before this function is invoked; the parameter is consumed here only
/// to satisfy the call shape. See kent8192/reinhardt-web#3971.
#[server_fn]
