//! Tests for users
//!
//! This module contains example tests for the users RESTful API application.
...
mod tests {
    ...
    fn test_viewset_create_action() {
        ...
        // let response = client.post("/api/users/", payload).await;
    ...
    fn test_api_authentication() {
        ...
        // Example:
        // let client = APIClient::new();
        // let response = client.get("/api/users/protected/").await;
