//! Tests for posts
//!
//! This module contains example tests for the posts RESTful API application.
...
mod tests {
    ...
    fn test_viewset_create_action() {
        ...
        // let response = client.post("/api/posts/", payload).await;
    ...
    fn test_api_authentication() {
        ...
        // Example:
        // let client = APIClient::new();
        // let response = client.get("/api/posts/protected/").await;
