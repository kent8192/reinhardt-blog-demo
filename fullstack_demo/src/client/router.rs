...
impl AppRoute {
	...
	pub fn render(&self, container: &Element) {
		match self {
			AppRoute::Home => {
				container.set_inner_html("<div class=\"container mt-5\"><h1>Welcome to fullstack_demo!</h1><p class=\"lead\">A modern WASM-based application built with Reinhardt Pages.</p></div>");
			}
			AppRoute::About => {
				container.set_inner_html("<div class=\"container mt-5\"><h1>About fullstack_demo</h1><p>This is a Reinhardt Pages application.</p></div>");
			}
			AppRoute::NotFound => {
