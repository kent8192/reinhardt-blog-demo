...
pub fn routes() -> UnifiedRouter {
    ...
    // Workaround: kent8192/reinhardt-web#3867 — viewset() is on ServerRouter, not UnifiedRouter
    let router = router.server(|r| r.viewset("/posts", crate::apps::posts::views::viewset()));
